!function($, wysi) {
	...
	var tpl = {
		...
		"speech": function(locale, options) {
			...
			return "<li>" +
					"<div class='btn-group'>" +
					"<a class='btn" + size + "' data-wysihtml5-command='insertSpeech' title='" + locale.speech.insert + "' tabindex='-1'><i class='icon-microphone'></i></a>" +
					"</div>" +
					"</li>";
		},
	...
	var defaultOptions = $.fn.wysihtml5.defaultOptions = {
		...
		stylesheets: ["../../../../web/bundles/hexmediaadministrator/css/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
		locale: "en"
	};
